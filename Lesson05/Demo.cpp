...
void Demo::DrawColoredCube()//baling-baling atas
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(initpos + position, 4.8, 0));

	model = glm::rotate(model, angle, glm::vec3(0, 1, 0));

	model = glm::scale(model, glm::vec3(0.5, 0.5, 13));
...
void Demo::DrawColoredCube2()// badan helicopter
{
	glUseProgram(shaderProgram);
	...
	model = glm::scale(model, glm::vec3(7, 3, 3));
...
void Demo::DrawColoredCube3()//ekor belakang
{
	glUseProgram(shaderProgram);
...
void Demo::DrawColoredCube4()//bawahnya baling-baling atas
{
	glUseProgram(shaderProgram);
...
void Demo::DrawColoredCube5()//baling-baling belakang
{
	glUseProgram(shaderProgram);
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(initpos2 + position + 3, 2, 1));
